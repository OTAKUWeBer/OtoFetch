...
from otofetch.types.artist import Artist
from otofetch.types.playlist import Playlist
from otofetch.types.saved import Saved
from otofetch.types.song import Song, SongList
from otofetch.utils.metadata import get_file_metadata
from otofetch.utils.spotify import SpotifyClient, SpotifyError
...
def get_simple_songs(
    ...
    for request in query:
        ...
        elif request.endswith(".otofetch"):
