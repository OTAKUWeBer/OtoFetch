...
def sync(
    ...
    if query and save_path:
        if any(req for req in query if req.endswith(".otofetch")):
            # If the query contains a .otofetch file, and we are about to create
            # .otofetch file, raise an error.
            raise ValueError(
                "Cannot create a sync file with a .otofetch file in the query."
            )
    ...
    if (  # pylint: disable=R1702
        ...
        and query[0].endswith(".otofetch")  # pylint: disable=R1702
