...
from otofetch.download.progress_handler import ProgressHandler
from otofetch.providers.audio import (
    AudioProvider,
    BandCamp,
    Piped,
    SoundCloud,
...
from otofetch.providers.lyrics import AzLyrics, Genius, LyricsProvider, MusixMatch, Synced
from otofetch.types.options import DownloaderOptionalOptions, DownloaderOptions
from otofetch.types.song import Song
from otofetch.utils.archive import Archive
from otofetch.utils.config import (
    DOWNLOADER_OPTIONS,
    GlobalConfig,
...
from otofetch.utils.ffmpeg import FFmpegError, async_convert, get_ffmpeg_path
from otofetch.utils.formatter import create_file_name
...
class Downloader:
    ...
    def __init__(
        ...
        # from otofetch.types.options.DOWNLOADER_OPTIONS
        ...
        # try to use the otofetch's ffmpeg
